package facebook.testng.annotations;
...
public class TestNGFacebookTest {
	...
	public void facebookTest() throws InterruptedException {
		...
		try {
			...
			System.out.println("Execute Catch Body");
			// terminating entire execution flow after catch body executed
			System.exit(0);
	...
	public void tearDown() throws InterruptedException {
		...
		driver.close();
		System.out.println("Browser Closed");
		System.out.println("Execute AfterSuite Body");
	}
